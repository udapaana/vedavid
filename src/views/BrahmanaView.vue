  ...
  <div class="max-w-6xl mx-auto px-4 py-8">
    <div class="mb-8">
      ...
      <p class="text-gray-600">
        Prose explanations and detailed ritual instructions
      </p>
    </div>
    ...
    <div class="grid lg:grid-cols-4 gap-8">
      ...
      <div class="lg:col-span-3">
        ...
        <div v-else-if="!selectedBook" class="text-center py-12">
          ...
          <p class="text-gray-600">Choose a book from the sidebar to begin studying the Brahmana texts.</p>
        </div>
...
const bookOptions = computed(() => {
  return vedaService.getBrahmanaBooks().map(book => ({
    value: book,
    label: `Book ${book}`
  }))
})
...
async function loadBook(book: string) {
  ...
  try {
    currentBook.value = await vedaService.getBrahmanaBook(book)
